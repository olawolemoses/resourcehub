        ...
        <div class="modal-content">
          ...
          <div class="modal-body loginSplash">
            ...
            @if(!Auth::check())
                ...
                <p class="text-center">Dont have an account? <a href="javascript:;" data-toggle="modal" data-target="#signupModal" data-dismiss="modal" aria-label="Close">Register</a></p>
          ...
          <div class="modal-body resetSplash">
            ...
            <p class="text-center logging"><a href="#">Go to login</a></p>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p class="text-center">Already have an account? <a href="javascript:;"  data-dismiss="modal" aria-label="Close"  data-toggle="modal" data-target="#loginModal">Login</a></p>
          </div>
          ...
          <ul class="navbar-nav mt-2 mt-lg-0">
            ...
            @elseif( Auth::user()->isActivated() )
                <li class="nav-item mynav dropdown">
                    @if( $cart_count > 0 )
                        <a class="dropdown-item" href="{{ route('viewcart') }}"> cart ({{ $cart_count }}) </a>
                    @endif
                    
                    @if( !is_null(Auth::user()->merchant) )
                        @include('includes.merchant_nav_dropdown')
                    @else
                        @include('includes.customer_nav_dropdown')
                    @endif
                </li>
            @endif
          </ul>
